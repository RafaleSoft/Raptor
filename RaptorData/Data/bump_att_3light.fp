...
ATTRIB iD3 = fragment.texcoord[6];
ATTRIB iS3 = fragment.texcoord[7];
...
PARAM specular_light3 = program.local[2];
...
DP3_SAT lit.x, iD3, normal;
DP3_SAT lit.y, iS3, normal;
MOV lit.w, shininess.x;
LIT lit,lit;
MUL lit, lit, iAtt.zzzz;
MAD diffuse, diffuse_mat, lit.y, diffuse;
MAD specular, lit.z, specular_light3, specular;
