...
flat(true)
{
	...
	{
		COUT << "Checking optimize offsets..." << endl;
		if ((int)(&tmpVect) - (int)(this) != (SHORT_OFFSET + TMPVECT_OFFSET))
			COUT << "ERROR tmpVect offset is wrong: it should be " << (int)(&tmpVect) - (int)(this) << " instead of " << 128 + TMPVECT_OFFSET << endl;
		if ((int)(&na) - (int)(this) != (SHORT_OFFSET + NORMAL_A_OFFSET))
			COUT << "ERROR na offset is wrong: it should be " << (int)(&na) - (int)(this) << " instead of " << 128 + NORMAL_A_OFFSET << endl;
		if ((int)(&nb) - (int)(this) != (SHORT_OFFSET + NORMAL_B_OFFSET))
			COUT << "ERROR nb offset is wrong: it should be " << (int)(&nb) - (int)(this) << " instead of " << 128 + NORMAL_B_OFFSET << endl;
		if ((int)(&nc) - (int)(this) != (SHORT_OFFSET + NORMAL_C_OFFSET))
			COUT << "ERROR nc offset is wrong: it should be " << (int)(&nc) - (int)(this) << " instead of " << 128 + NORMAL_C_OFFSET << endl;
		if ((int)(&u) - (int)(this) != (SHORT_OFFSET + NORMAL_U_OFFSET))
			COUT << "ERROR u offset is wrong: it should be " << (int)(&u) - (int)(this) << " instead of " << 128 + NORMAL_U_OFFSET << endl;
		if ((int)(&v) - (int)(this) != (SHORT_OFFSET + NORMAL_V_OFFSET))
			COUT << "ERROR v offset is wrong: it should be " << (int)(&v) - (int)(this) << " instead of " << 128 + NORMAL_V_OFFSET << endl;
		if ((int)(&w) - (int)(this) != (SHORT_OFFSET + NORMAL_W_OFFSET))
			COUT << "ERROR w offset is wrong: it should be " << (int)(&w) - (int)(this) << " instead of " << 128 + NORMAL_W_OFFSET << endl;
...
COUT << "          [" << u << "] [" << v << "] [" << w << "]" << endl;
CGenericVector<float> hit(-4,-4,-5,1);
GetTexel(hit);
COUT << "GetTexel -: " << tmpVect << endl;
hit.Set(4,-4,-5,1);
GetTexel(hit);
COUT << "GetTexel +: " << tmpVect << endl;
hit.Set(0,-4,-5,1);
GetTexel(hit);
COUT << "GetTexel 0: " << tmpVect << endl;
*/
}
