...
void CGenericRay::Hit( LPRAYTRACERDATA World , CWVector &c)
{
...
float CGenericRay::Light_Hit( LPRAYTRACERDATA World, CWVector &c,CGenericLight *light)
{
	float			fact = this->fact ;
	float			t,k,d;
	int				size=World->objects.GetSize();
