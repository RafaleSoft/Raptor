// SSE_CRenderObject.cpp: implementation of the SSE_CRenderObject class.
//
//////////////////////////////////////////////////////////////////////
...
SSE_CRenderObject::SSE_CRenderObject(rays_objectbase_t base):
	CGenericRenderObject(CString(base.name))
{
	bBox = new SSE_CBoundingBox();
...
SSE_CRenderObject::~SSE_CRenderObject()
{
	delete bBox;
}

CWVector& SSE_CRenderObject::GetLocalColor(const CGenericRay &ray)
{
	if (m_pTexture != NULL)
	{
...
float SSE_CRenderObject::FastIntersect( CGenericRay &ray )
{ 
	float res = bBox->Intersect(ray);
