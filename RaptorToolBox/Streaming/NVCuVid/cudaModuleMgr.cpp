...
extern "C"
bool modInitCTX(sCtxModule *pCtx, const char *filename, int nKernels, int nGlobalMem, int nTexRef)
{
...
CUmoduleManager::CUmoduleManager(const char *filename_module,
                                 ...
                                 int nTexRef)
{
    if (modInitCTX(&mCtx, filename_module, nKernels, nGlobalMem, nTexRef) == false)
    {
