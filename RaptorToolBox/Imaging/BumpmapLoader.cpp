...
CBumpmapLoader::CBumpmapLoader(float scale)
	:bump_scale(scale)
{

}

CBumpmapLoader::CBumpmapLoader(const CBumpmapLoader& loader)
	: bump_scale(loader.bump_scale)
{
}

CBumpmapLoader& CBumpmapLoader::operator=(const CBumpmapLoader& loader)
{
	bump_scale = loader.bump_scale;
	return *this;
}

CBumpmapLoader::~CBumpmapLoader()
{

}

bool CBumpmapLoader::apply(CImage* const src) const
{
    if (src == NULL)
		return false;
