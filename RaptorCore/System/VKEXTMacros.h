...
//!
		...
		{\
			target->vkCreateXlibSurfaceKHR = (PFN_vkCreateXlibSurfaceKHR)(vkGetInstanceProcAddr(instance, "vkCreateXlibSurfaceKHR")); \
			target->vkGetPhysicalDeviceXlibPresentationSupportKHR = (PFN_vkGetPhysicalDeviceXlibPresentationSupportKHR)(vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceXlibPresentationSupportKHR"));\
		}
	#else
		#define IMPLEMENT_VK_xlib(target,instance)
