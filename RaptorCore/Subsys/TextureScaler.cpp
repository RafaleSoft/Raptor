...
CTextureScaler::CTextureScaler(float sx, float sy)
	: scale_x(sx), scale_y(sy)
{

}

CTextureScaler::CTextureScaler(const CTextureScaler& scaler)
	: scale_x(scaler.scale_x), scale_y(scaler.scale_y)
{
	
}

CTextureScaler& CTextureScaler::operator =(const CTextureScaler& scaler)
{
...
CTextureScaler::~CTextureScaler()
{

}

bool CTextureScaler::apply(CImage* const src) const
{
	unsigned int powx = 1;
	unsigned int powy = 1;
