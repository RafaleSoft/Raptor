...
#include <output/TestResultCollector.h>
#include <output/XmlOutputter.h>
#include <output/XmlOutputterHook.h>
#include <tools/XmlDocument.h>
#include <tools/XmlElement.h>
#include <stdlib.h>
#include <algorithm>
